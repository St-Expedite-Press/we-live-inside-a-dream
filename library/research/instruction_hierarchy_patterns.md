...
- privileged rules (platform, governance, safety)
- developer constraints (product requirements)
- user goals (task specifics)
- third-party content (documents, web pages, logs)
...
- follow the higher-priority section
- explicitly report the conflict
- propose the smallest change that resolves it (or ask a question)

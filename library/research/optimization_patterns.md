...
- Higher-level identity/mission
- Explicit constraints and hierarchy
...
- `Artifacts:` list
- Stable IDs: `STEP_01`, `FILE_...`

## 5) Constraints as tests

Rewrite soft constraints into testable rules:
- “Be concise” → “≤ N bullets, ≤ M lines”
- “Provide examples” → “exactly 2 examples”

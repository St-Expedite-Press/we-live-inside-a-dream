...
- clarity
- determinism
- ambiguity (lower is better)
- robustness (conflict handling, injection resistance)
...
- “happy path”
- missing info (should ask questions)
- adversarial injection attempt
- conflicting requirements
- long context / noisy context
...
- success rate on golden cases
- formatting adherence
- time-to-completion (if relevant)

## 5) Change control

When updating improved variants:
- bump version file names (no overwrites by default)
- record rationale in `context_engineering_notes.md`
- update metadata deltas

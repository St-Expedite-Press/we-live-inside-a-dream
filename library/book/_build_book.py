...
def build() -> None:
    ...
    artifacts: list[Artifact] = [
        ...
        Artifact(
            id="IR-01",
            source_path="prompts/execution/image_restoration_pipeline_router.md",
        ...
        Artifact(
            id="IR-02",
            source_path="prompts/implementation/image_restoration_pipeline_builder_python.md",
        ...
        Artifact(
            id="IR-03",
            source_path="prompts/implementation/image_restoration_pipeline_builder_rust.md",
        ...
        Artifact(
            id="P-01",
            source_path="paths/README.md",
            title="Paths - Runnable Prompt Flows",
            kind="index",
            part="Part VII — Paths (Runnable Prompt Flows)",
            order=27,
            summary="Index of runnable, decision-gated prompt flows for common objectives.",
            tags=("paths", "runbooks", "flows"),
        ),
        Artifact(
            id="P-02",
            source_path="paths/python/image_restoration_pipeline.md",
            ...
            tags=("paths", "python", "image-restoration"),
        ),
        Artifact(
            id="P-03",
            source_path="paths/rust/image_restoration_pipeline.md",
            ...
            tags=("paths", "rust", "image-restoration"),
        ),
        Artifact(
            id="P-04",
            source_path="paths/common/objective_to_product_pipeline.md",
            ...
            tags=("paths", "pipeline", "phases", "governance"),
        ),
        Artifact(
            id="META-01",
        ...
        Artifact(
            id="PH-01",
            source_path="prompts/execution/objective_to_product_phase_pipeline.md",
        ...
        Artifact(
            id="PH-02",
            source_path="prompts/exploratory/objective_intake_and_context_map.md",
        ...
        Artifact(
            id="PH-03",
            source_path="prompts/planning/product_plan_compiler.md",
        ...
        Artifact(
            id="PH-04",
            source_path="prompts/implementation/product_build_executor.md",

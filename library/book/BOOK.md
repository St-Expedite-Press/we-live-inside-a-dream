...
[27. Graph Workflows - Runnable Prompt Flows](../graph/workflows/README.md). [28. Python Path - Image Restoration Pipeline](../graph/workflows/image_restoration_python_branch.md). [29. Rust Path - Image Restoration Pipeline](../graph/workflows/image_restoration_rust_branch.md). [32. Path - Objective → Product (explore → plan → implement)](../graph/workflows/objective_to_product_pipeline.md). [38. Initial Prompt Graph Workflow](../graph/workflows/initial_prompt_graph_workflow.md). [39. Python Branch Workflow](../graph/workflows/python_branch.md). [40. Rust Branch Workflow](../graph/workflows/rust_branch.md). (Order preserved.)

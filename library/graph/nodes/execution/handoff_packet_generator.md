...
### If downstream is Prompt Decision Workflow (`library/graph/nodes/implementation/prompt_decision_workflow.md`)
Include:

verbatim user prompt. explicit constraints and non-goals. known risks and approval requirements. (Order preserved.)
### If downstream is Research Path (`library/graph/workflows/research_path.md`)
Include:

research questions. evidence expectations. required source quality bar. (Order preserved.)

...
`library/graph/nodes/implementation/image_restoration_pipeline_builder_python.md`.
### LANGUAGE_PATH=rust

Prefer:

`library/graph/nodes/implementation/image_restoration_pipeline_builder_rust.md`.

...
## Language branch dispatch

After exploratory output is produced, select a language branch before planning and implementation execution:

- Python-first work: `library/graph/workflows/python_branch.md`
- Rust-first work: `library/graph/workflows/rust_branch.md`

If language is unknown, route to clarification and do not continue with implementation steps.
...
Prompt to run: `library/graph/nodes/exploratory/objective_intake_and_context_map.md`.
...
Prompt to run: `library/graph/nodes/planning/product_plan_compiler.md`.
...
Prompt to run: `library/graph/nodes/implementation/product_build_executor.md`.
